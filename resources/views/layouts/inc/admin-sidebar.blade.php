    ...
    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                <a class="nav-link {{ Request::is('admin/add-category') ? 'collapse active' : 'collapsed' }}" href="#"
                ...
                <div class="collapse {{ Request::is('admin/add-category') ? 'show' : 'collapsed' }}"
                ...
                <a class="nav-link {{ Request::is('admin/comments') }}" href="{{ url('admin/comments') }}">
                    <div class="sb-nav-link-icon"><i class="fas fa-chart-area"></i></div>
                    Comments
                </a>
    </nav>
